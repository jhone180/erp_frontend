            ...
            <div class="box-body">
              ...
              <div class="box">
                ...
                foreach ($listaProducto as $key => $value) {
                  ...
                  $respueta = ControladorProductos::ctrMostrarProductos($item, $valor, $orden);
                  ...
                  echo '<div class="row" style="padding:5px 15px">
                        ...
                        <div class="col-xs-3 ingresoPrecio" style="padding-left:0px">
                          ...
                          <div class="input-group">
                            ...
                            <input type="text" class="form-control nuevoPrecioProducto" precioReal="'.$respuesta["costo_venta"].'" name="nuevoPrecioProducto" value="'.$value["total"].'" readonly required>
