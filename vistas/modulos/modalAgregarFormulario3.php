...
<script>
    ...
    $(document).ready(function() {
        $('#formXRM').on('submit', function(event) {
            ...
            fetch('http://localhost:8080/quality/xrm/saveAll', { // Reemplaza esto con la URL de tu API
                method: 'POST',
                headers: {
    ...
    $(document).ready(function() {
        fetch('http://localhost:8080/quality/xrm/getAll?userId=' + <?php echo $_SESSION['id'] ?>, { // Reemplaza esto con la URL de tu endpoint
            method: 'GET',
            headers: {
                'Content-Type': 'application/json'
            }
    ...
    $(document).ready(function() {
        ...
        $('.table').on('change', 'input[id^="sample_weightXRM_"]', function() {
            ...
            fetch('http://localhost:8080/quality/xrm/update', { // Reemplaza esto con la URL de tu API
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
    ...
    $(document).ready(function() {
        $('#deleteAllXRM').click(function() {
            $.ajax({
                url: "http://localhost:8080/quality/xrm/deleteAll?userId=" + <?php echo $_SESSION['id'] ?>, // Cambia esto por la URL de tu API
                type: "DELETE",
